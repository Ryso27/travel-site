...
imagemin = require('gulp-imagemin'), //minify package
del = require('del'),
usemin = require('gulp-usemin'), //copy to dist, compress file-size, revision
rev = require('gulp-rev'), //help revision files
